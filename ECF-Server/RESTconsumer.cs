...
namespace ECF_Server
{
    public class RESTconsumer
    {
        ...
        public static IRestResponse setDelieveryTimeWindowEarliest(string HTTPMethod, Uri URL, string timeConstraint)
        {
            // This method is used for making api calls
            // HTTPMethod - The HTTP request method. e.g GET, POST, etc.
            // URL - The api url for the request
            ...
            var request = new RestRequest(Method.POST);
            request.AddHeader("Content-Type", "application/json");
            request.AddParameter("application / json", "{\n\n  \"ecf_schedule_time_earliest\": \"" + timeConstraint + "\"\n}", ParameterType.RequestBody);

            return client.Execute(request);

        }

        public static IRestResponse setDelieveryTimeWindowLatest(string HTTPMethod, Uri URL, string timeConstraint)
        {
            // This method is used for making api calls
            // HTTPMethod - The HTTP request method. e.g GET, POST, etc.
            // URL - The api url for the request
            ...
            var request = new RestRequest(Method.POST);
            request.AddHeader("Content-Type", "application/json");
            request.AddParameter("application / json", "{\n\n  \"ecf_schedule_time_latest\": \"" + timeConstraint + "\"\n}", ParameterType.RequestBody);
        ...
        public RootOrderNote apiSetDelieveryWindowEarliest(string HTTPMethod, string requestURL, string timeConstraint)
        {
            // This method is used for the orders/{id} API call that returns the order data
            // HTTPMethod - The HTTP request method. e.g GET, POST, etc.
            // requestURL - The extension to be added to the base url. Where the base url is: https://epic.elliscreekfarm.co.nz/wp-json/wc/v3/  
            ...
            var BASE_URL = new Uri(mainURL + requestURL);
            IRestResponse response = setDelieveryTimeWindowEarliest(HTTPMethod, BASE_URL, timeConstraint);

            //Console.WriteLine(response.Content);
            return JsonConvert.DeserializeObject<RootOrderNote>(response.Content);
        }

        public RootOrderNote apiGetDelieveryWindowEarliest(string HTTPMethod, string requestURL)
        {
            // This method is used for the orders/{id} API call that returns the order data
            // HTTPMethod - The HTTP request method. e.g GET, POST, etc.
            // requestURL - The extension to be added to the base url. Where the base url is: https://epic.elliscreekfarm.co.nz/wp-json/wc/v3/  
        ...
        public RootOrderNote apiSetDelieveryWindowLatest(string HTTPMethod, string requestURL, string timeConstraint)
        {
            // This method is used for the orders/{id} API call that returns the order data
            // HTTPMethod - The HTTP request method. e.g GET, POST, etc.
            // requestURL - The extension to be added to the base url. Where the base url is: https://epic.elliscreekfarm.co.nz/wp-json/wc/v3/  
